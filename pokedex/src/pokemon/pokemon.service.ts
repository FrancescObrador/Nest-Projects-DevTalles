...
import { PaginationDto } from 'src/common/dto/pagination-dto.dto';
...
export class PokemonService {
  ...
  private handleExeptions(error: any){
    ...
    throw new InternalServerErrorException(`Can not create Pokemon - internal server error`)
  }
}
